// Dữ liệu Mainboard
// Ensure window exists (for Node.js compatibility)
...
window.mainboardData = {
    ...
    "B75": {
        "name": "ASUS B75M-A (LGA1155 - Cũ)",
        "price": 500000,
        "image": "images/asus-b85m-g.jpg",
        "brand": "ASUS (Cũ)",
        "warranty": "1 tháng",
        "sockets": ["LGA1155"], // Tương thích với i5-3470
        "memoryType": "DDR3",
        "condition": "2ND",
        "nvmeSlots": 0,
        "pcieVersion": "2.0",
    ...
    "B150": {
        ...
        "brand": "Gigabyte (Cũ)",
        "warranty": "1 tháng",
        "sockets": ["LGA1151"], // Tương thích với i5-6500
        "memoryType": "DDR4",
        "condition": "NEW",
        "nvmeSlots": 0,
        "pcieVersion": "3.0",
    ...
    "B250": {
        ...
        "brand": "ASUS (Cũ)",
        "warranty": "1 tháng",
        "sockets": ["LGA1151"], // Tương thích với i5-6500, i5-7400
        "memoryType": "DDR4",
        "condition": "NEW",
        "nvmeSlots": 1,
        "pcieVersion": "3.0",
...
export const mainboardData = window.mainboardData; 